  ...
  const questions = [
    {
      ...
      type: "single",
      options: [
        { value: "30-34", label: "30-34 Jahre" },
        { value: "35-39", label: "35-39 Jahre" },
        { value: "40-44", label: "40-44 Jahre" },
        { value: "45-49", label: "45-49 Jahre" },
        { value: "50-54", label: "50-54 Jahre" },
        { value: "55-59", label: "55-59 Jahre" },
    ...
    },
    {
      ...
      type: "multiple",
      options: [
        { value: "irregular-periods", label: "Unregelmäßige Perioden" },
        { value: "heavy-periods", label: "Starke Blutungen" },
        { value: "hot-flashes", label: "Hitzewallungen" },
        { value: "night-sweats", label: "Nachtschweiß" },
        { value: "sleep-issues", label: "Schlafprobleme" },
        { value: "insomnia", label: "Schlaflosigkeit" },
        { value: "mood-changes", label: "Stimmungsschwankungen" },
        { value: "anxiety", label: "Ängstlichkeit" },
        { value: "depression", label: "Depressive Verstimmung" },
        { value: "irritability", label: "Reizbarkeit" },
        ...
        { value: "muscle-aches", label: "Muskelschmerzen" },
        { value: "dry-skin", label: "Trockene Haut" },
        { value: "dry-hair", label: "Trockene/dünne Haare" },
        { value: "hair-loss", label: "Haarausfall" },
        { value: "vaginal-dryness", label: "Scheidentrockenheit" },
        { value: "low-libido", label: "Verminderte Libido" },
        { value: "headaches", label: "Kopfschmerzen/Migräne" },
        { value: "fatigue", label: "Müdigkeit/Erschöpfung" },
        { value: "breast-tenderness", label: "Brustspannen" },
    ...
    },
    {
      ...
      options: [
        ...
        { value: "early-peri", label: "Frühe Perimenopause (leichte Veränderungen)" },
        { value: "late-peri", label: "Späte Perimenopause (starke Unregelmäßigkeiten)" },
        { value: "meno", label: "Menopause (keine Periode seit 12+ Monaten)" },
        { value: "post", label: "Postmenopause (mehrere Jahre ohne Periode)" },
        { value: "surgical", label: "Chirurgische Menopause" },
        { value: "unsure", label: "Ich bin mir nicht sicher" },
      ],
    },
    {
      id: "lifestyle", 
      title: "Wie würdest du deinen aktuellen Lebensstil beschreiben? (Mehrfachauswahl möglich)",
      type: "multiple",
      options: [
        { value: "regular-exercise", label: "Regelmäßiger Sport (3+ mal/Woche)" },
        { value: "occasional-exercise", label: "Gelegentlicher Sport (1-2 mal/Woche)" },
        { value: "sedentary", label: "Wenig körperliche Aktivität" },
        { value: "balanced-diet", label: "Ausgewogene Ernährung" },
        { value: "stress-management", label: "Aktives Stressmanagement" },
        { value: "high-stress", label: "Hohes Stresslevel" },
        { value: "good-sleep", label: "Gute Schlafgewohnheiten" },
        { value: "smoking", label: "Rauchen" },
        { value: "alcohol-regular", label: "Regelmäßiger Alkoholkonsum" },
        { value: "meditation", label: "Meditation/Achtsamkeit" },
      ],
    },
    {
      id: "priorities",
      title: "Was ist dir aktuell am wichtigsten? (Mehrfachauswahl möglich)",
      type: "multiple", 
      options: [
        { value: "symptom-relief", label: "Symptomlinderung" },
        { value: "natural-remedies", label: "Natürliche Behandlungsmethoden" },
        { value: "hormone-therapy", label: "Information über Hormontherapie" },
        { value: "nutrition-support", label: "Ernährungsberatung" },
        { value: "fitness-guidance", label: "Fitness und Bewegung" },
        { value: "mental-health", label: "Psychische Gesundheit" },
        { value: "sleep-improvement", label: "Besserer Schlaf" },
        { value: "weight-management", label: "Gewichtsmanagement" },
        { value: "bone-health", label: "Knochengesundheit" },
        { value: "heart-health", label: "Herzgesundheit" },
        { value: "community-support", label: "Austausch mit anderen Frauen" },
        { value: "medical-guidance", label: "Ärztliche Beratung" },
      ],
    },
  ];
